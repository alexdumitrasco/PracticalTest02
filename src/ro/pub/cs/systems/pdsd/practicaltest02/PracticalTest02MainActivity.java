...
public class PracticalTest02MainActivity extends Activity {
    ...
    private EditText searchedWordEditText = null;
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String searchedWord = searchedWordEditText.getText().toString();
            if (searchedWord == null || searchedWord.isEmpty()) {
                Toast.makeText(
                        getApplicationContext(),
                        "Parameters from client (searchedWord / information type) should be filled!",
                        Toast.LENGTH_SHORT
                ).show();
                return;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchedWordEditText = (EditText)findViewById(R.id.city_edit_text);
